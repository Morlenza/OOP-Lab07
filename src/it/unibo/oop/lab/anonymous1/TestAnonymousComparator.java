...
public final class TestAnonymousComparator {
    ...
    public static void main(final String... args) {
        ...
        Collections.sort(denzelUsers, new Comparator<User>() {
			...
			/**
			 * @param o1
			 * 				the first user of comparison
			 * @param o2    
			 * 				the second user of comparison
			 * @return 
			 * 				(considering the age) the value 0 if o1 == o2 ; a value less than 0 if o1 < o2; and a value greater than 0 if o1 > o2
			 * 
			 */
